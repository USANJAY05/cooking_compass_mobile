...
export const RecipesFeedScreen = () => {
   ...
   * RECIPE SKELETON
   *
   * The search bar remains visible.
   * Only the recipe-list area is replaced by skeleton cards.
   * ============================================================
   */
      ...
      <View style={styles.centerContainer}>
        ...
        >
          {isSearching
            ...
            : 'No recipes available in the feed'}
        </Text>
      </View>
    );
  };
  ...
  const renderContent = () => {
    /*
     * IMPORTANT:
     * Do NOT return a full-screen loading page.
     *
     * The search bar stays mounted above this content.
     * Only the recipe list becomes skeletons.
     */
